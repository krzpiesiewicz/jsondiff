...
setup(
    ...
    version=version,
    description='Diff JSON and JSON-like structures in Python (modified https://github.com/ZoomerAnalytics/jsondiff)',
    author='Zoomer Analytics LLC and Krzysztof Piesiewicz',
    author_email='krz.piesiewicz@gmail.com',
    url='https://github.com/krzpiesiewicz/jsondiff',
